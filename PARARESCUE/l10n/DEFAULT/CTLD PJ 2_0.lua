...
ctld.minimumDeployDistance = 20 -- minimum distance from a friendly pickup zone where you can deploy a crate

ctld.numberOfTroops = 10 -- default number of troops to load on a transport heli or C-130 
							-- also works as maximum size of group that'll fit into a helicopter unless overridden
ctld.enableFastRopeInsertion = true -- allows you to drop troops by fast rope
ctld.fastRopeMaximumHeight = 35 -- in meters which is 60 ft max fast rope (not rappell) safe height
...
ctld.spawnableCrates = {
	...
	--{ weight = 500, desc = "M1A2 Abrams", unit = "M-1 Abrams", side = 2, cratesRequired = 3 },
	--{ weight = 501, desc = "M60A3 Patton", unit = "M-60", side = 2, cratesRequired = 2 },
	--{ weight = 502, desc = "M2A2 Bradley", unit = "M-2 Bradley", side = 2, cratesRequired = 2 },
	--{ weight = 503, desc = "LAV-25", unit = "LAV-25", side = 2, cratesRequired = 1 },
	--{ weight = 504, desc = "HMMWV - TOW", unit = "M1045 HMMWV TOW", side = 2, cratesRequired = 1 },
	
	
	--{ weight = 950, desc = "T-55", unit = "T-55", side = 1, cratesRequired = 2 },
	--{ weight = 951, desc = "T-72B", unit = "T-72B", side = 1, cratesRequired = 3 },
	--{ weight = 952, desc = "BMP-2", unit = "BMP-2", side = 1, cratesRequired = 2 },
	--{ weight = 953, desc = "BTR-80", unit = "BTR-80", side = 1, cratesRequired = 1 },
	--{ weight = 954, desc = "BMD-1", unit = "BMD-1", side = 1, cratesRequired = 1 },
	--{ weight = 955, desc = "BMP-1", unit = "BMP-1", side = 1, cratesRequired = 1 },
	...
	--["Support Crates"] = {
        ...
        --{ weight = 497, desc = "M-109 Paladin", unit = "M-109", side = 2, cratesRequired = 2 },
		--{ weight = 498, desc = "M270 MLRS", unit = "MLRS", side = 2, cratesRequired = 2 },
		--{ weight = 499, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
		--{ weight = 505, desc = "M-818 Ammo Truck", unit = "M 818", side = 2, cratesRequired = 1 },
		--{ weight = 506, desc = "M978 Fuel Truck", unit = "M978 HEMTT Tanker", side = 2, cratesRequired = 1 },
		
		--{ weight = 900, desc = "Early Warning Radar", unit = "1L13 EWR", side = 1, cratesRequired = 2 }, -- cant be used by BLUE coalition
		--{ weight = 901, desc = "SKP-11 - JTAC", unit = "SKP-11", side = 1, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
		--{ weight = 902, desc = "Ural-375 Ammo Truck", unit = "Ural-375", side = 1, cratesRequired = 1 },
		--{ weight = 903, desc = "Fuel Truck ATZ-10 ", unit = "ATZ-10", side = 1, cratesRequired = 1 },
		--{ weight = 904, desc = "SAU Msta ", unit = "SAU Msta", side = 1, cratesRequired = 2 },
		--{ weight = 905, desc = "Grad-URAL MLRS", unit = "Grad-URAL", side = 1, cratesRequired = 2 },
		

        
		--{ weight = 510, desc = "BTR-D", unit = "BTR_D", side = 1 },
        --{ weight = 500, desc = "BMP-2", unit = "IFV BMP-2", side = 1 },
		--{ weight = 500, desc = "SPH 2S19 Msta", unit = "SAU Msta", side = 1, cratesRequired = 2 },
    ...
    --["SAM Crates"] = {
        ...
        -- KUB SYSTEM
        --{ weight = 1060, desc = "KUB Launcher", unit = "Kub 2P25 ln", side = 1},
        --{ weight = 1065, desc = "KUB Radar", unit = "Kub 1S91 str", side = 1 },
        --{ weight = 1070, desc = "KUB Repair", unit = "KUB Repair", side = 1},
        -- End of KUB
	...
	--{ weight = 480, desc = "M1097 Avenger", unit = "M1097 Avenger", side = 2, cratesRequired = 1 },
	--{ weight = 481, desc = "M163 Vulcan", unit = "Vulcan", side = 2, cratesRequired = 1 },
	--{ weight = 482, desc = "Roland Launcher", unit = "Roland ADS", side = 2, cratesRequired = 2 },
	--{ weight = 483, desc = "Roland Search Radar", unit = "Roland Radar", side = 2, cratesRequired = 1 },
	--{ weight = 484, desc = "M48 Chaparral", unit = "M48 Chaparral", side = 2, cratesRequired = 1 },
	--{ weight = 485, desc = "M6 Linebacker", unit = "M6 Linebacker", side = 2, cratesRequired = 2 },
	

	
	--{ weight = 970, desc = "Strela-1 9P31", unit = "Strela-1 9P31", side = 1, cratesRequired = 1 },
	--{ weight = 971, desc = "ZSU-23-4 Shilka", unit = "ZSU-23-4 Shilka", side = 1, cratesRequired = 1 },
	--{ weight = 972, desc = "Osa 9A33 ln", unit = "Osa 9A33 ln", side = 1, cratesRequired = 3 },
	--{ weight = 973, desc = "Ural-375 ZU-23", unit = "Ural-375 ZU-23", side = 1, cratesRequired = 1 },
...
function ctld.safeToFastRope(_heli)
    ...
    if (ctld.inAir(_heli) == false or (ctld.heightDiff(_heli) <= ctld.fastRopeMaximumHeight + 3.0 and mist.vec.mag(_heli:getVelocity()) < 80)) then
        return true
    end
end
            ...
            if ctld.inAir(_heli) == false or ctld.safeToFastRope(_heli) then
                ...
                if _extractZone == false then
                    ...
                    if ctld.inAir(_heli) then
                        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " troops air-dropped from " .. _heli:getTypeName() .. " into combat", 10)
                    else
